...
export const getPublicKey = vi.fn(
  async (): Promise<{
    ...
    return {
      compressedPublicKey: '02a1b2c3d4e5f6a1b2c3d4e5f6a1b2c3d4e5f6a1b2c3d4e5f6a1b2c3d4e5f6a1b2',
...
export const getAddress = vi.fn(async (params: unknown): Promise<{ address: ArkadeAddress }> => {
  ...
  return {
    address:
      `${prefix}` as ArkadeAddress,
  };
});
